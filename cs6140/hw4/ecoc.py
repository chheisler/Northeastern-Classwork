...
def train(folder, code_len, learner, predictor):
    data, labels, num_classes = load_trec(folder)
...
def test(folders, codes, predictors):
    data, labels, _ = load_trec(folders)
...
def main():
    ...
    codes, predictors = train('data/8newsgroup/train.trec', 20, learner, adaboost.predict)
